<nav class="navbar navbar-expand-lg navbar-light bg-primary">
  <div class="container-fluid ">
    <a class="navbar-brand text-white" href="#">SCHP</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav ">
        <li class="nav-item">
          <a class="nav-link active text-white" aria-current="page" href="index.php">SIMULADOR</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="#">CONTACTANOS</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="#">Abre tu Cuenta</a>
        </li>
